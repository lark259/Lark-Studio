  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section id="about" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-8">소개</h2>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-16">서비스 및 가격 안내</h2>
          
          {/* 일반 포토샵 작업 */}
          <div className="max-w-4xl mx-auto mb-16">
            <h3 className="text-2xl font-bold text-gray-900 mb-8">📸 일반 포토샵 작업</h3>
            <div className="grid gap-8 md:grid-cols-3">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">기본 보정</h4>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">고급 편집</h4>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">합성 작업</h4>
          ...
          {/* 영정사진 보정 및 액자 */}
          <div className="max-w-4xl mx-auto mb-16">
            <h3 className="text-2xl font-bold text-gray-900 mb-8">📋 영정사진 보정 및 액자</h3>
            <div className="grid gap-8 md:grid-cols-2">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">영정사진 보정</h4>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">액자 포함 패키지</h4>
                <ul className="text-gray-600 space-y-4">
                  <li className="flex justify-between items-center">
                    <span>8인치 액자 포함</span>
          ...
          {/* 사진 촬영 */}
          <div className="max-w-4xl mx-auto mb-16">
            <h3 className="text-2xl font-bold text-gray-900 mb-8">📋 사진 촬영</h3>
            <div className="grid gap-8 md:grid-cols-2">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">증명사진 촬영</h4>
                <p className="text-2xl font-bold text-blue-600 mb-2">25,000원</p>
                <p className="text-gray-600">9장 인화 및 파일 제공</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">프로필 사진 촬영</h4>
          ...
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-8">📋 사진 인화</h3>
            <div className="grid gap-4 md:grid-cols-4">
              <div className="bg-white p-4 rounded-lg shadow-lg text-center">
                <h4 className="font-semibold text-gray-900 mb-2">4x6</h4>
                <p className="text-xl font-bold text-blue-600">1,000원</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-lg text-center">
                <h4 className="font-semibold text-gray-900 mb-2">5x7</h4>
                <p className="text-xl font-bold text-blue-600">2,000원</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-lg text-center">
                <h4 className="font-semibold text-gray-900 mb-2">8x10</h4>
                <p className="text-xl font-bold text-blue-600">10,000원</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-lg text-center">
                <h4 className="font-semibold text-gray-900 mb-2">11x14</h4>
      ...
      <section id="gallery" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-16">갤러리</h2>
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-8">문의하기</h2>
          <div className="max-w-lg mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex flex-col space-y-4">
                <p className="text-gray-600">📞 전화: 010-8646-3081</p>
                <p className="text-gray-600">📱 카카오톡: @라크네 사진관</p>
                <p className="text-gray-600">📧 이메일: sofu234@naver.com</p>
                <p className="text-gray-600">📍 주소: 경기도 수원시 장안구 율전동 182-13 라크네 사진관</p>
              </div>
              <div className="mt-8">
                <p className="text-gray-600 mb-4">카카오톡으로 편하게 문의해주세요</p>
                <Image
                  src="/qr-code.png"
                  alt="카카오톡 QR 코드"
                  width={200}
